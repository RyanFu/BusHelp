...
- (void)initView{
    ...
    mile = [[UILabel alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-5, self.bounds.size.width, 26)];
    mile.numberOfLines=0;
    mile.textColor = [UIColor redColor];
    mile.font = [UIFont boldSystemFontOfSize:9];
    mile.textAlignment = NSTextAlignmentCenter;
    [self addSubview:mile];
