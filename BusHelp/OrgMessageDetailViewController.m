...
- (void)setupMessageReadStatus {
    if (([self.orgMessage.action integerValue] == OrgMessageTypeCommon||[self.orgMessage.action integerValue]==OrgMessageTypeNormal || [self.orgMessage.action integerValue] == OrgMessageTypeManual || [self.orgMessage.action integerValue] == OrgMessageTypeOrgTask || [self.orgMessage.action integerValue] == OrgMessageTypeViolation) && [self.orgMessage.isRead isEqualToString:orgMessageNotRead]) {
